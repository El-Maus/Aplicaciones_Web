	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			<ul class="nav navbar-nav">
				...
				<li style="top:10px;left:20px;"><button class="btn btn-primary" id="search_btn">Búsqueda</button></li>
			</ul>
			<ul class="nav navbar-nav navbar-right">
				<li><a href="#" id="cart_container" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Cesta<span class="badge">0</span></a>
		...
		<div class="row">
			...
			<div class="col-md-8">	
				...
				<div class="panel panel-info" id="scroll">
					...
					<div class="panel-footer">Apps Web</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
